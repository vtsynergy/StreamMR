...
class StringMatch 
{
    std::string  fileName, keyWord;
	cl_int fileSize, kwordSize,userSize;
	char* h_filebuf;
        cl_int sizePerMap;
   ...
   public:
     ...
     */
    explicit StringMatch(std::string name)
    {
		h_filebuf=NULL;
    }
     ...
     */
    explicit StringMatch(const char* name) 
    {
		 h_filebuf=NULL;
    }
